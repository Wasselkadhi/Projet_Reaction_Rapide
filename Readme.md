...
## Fonctionnalités principales:
        ...
        il y a aussi un boutton pour avoir le dernier score realiser
        et enfin un boutton qui va donner un guide de utilisation aux utilisateur
        lors de debut de jeu l'ecran va changer de couleur et un signal aleatoire va apparaitre ,lors de l'apparence de 
...
## Nouveautés explorées:
        ...
        l'attribut srcdoc qui nous permet de afficher une page sur iframe avec son code et non son lien
        comment manipuler les fichier audios a partir de javascript 
        comment manipuler les touches/click et les evenement qui seront executeés lors de click
...
## Solutions apportées:
        utilisation de srcdoc qui va faciliter le travail sans un lien d'une page externe 
        a l'aide de deepseek j'ai resolu la pluspart des problemes conçernant les positons aleatoires et leur affichage
